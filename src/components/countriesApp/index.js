...
class Countries extends Component {
  ...
  getFilteredCountries = countriesList => {
  ...
  render() {
    ...
    const filteredCountries = this.getFilteredCountries(countriesList)
    return (
      <div className="app-container">
        ...
        <ul className="visited-countries">
          {filteredCountries.length > 0
            ...
            : this.renderEmptyVisitedCountries()}
        </ul>
      </div>
    )
  }
